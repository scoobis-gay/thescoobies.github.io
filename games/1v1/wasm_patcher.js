...
class WasmPatcher {
    constructor(wasmBuffer) {
        this._oldWasm = new BufferReader2(new Uint8Array(wasmBuffer));
    ...
    _parseTypeSection() {
        ...
        const oldSection = new BufferReader2(sectionBody);
    ...
    _applyAobPatch(oldBody) {
        ...
        this._aobPatchEntries.forEach(entry => {
            ...
            const oldBodyReader = new BufferReader2(body);
            ...
            const matchBytesReader = new BufferReader2(matchBytes);
    ...
    _parseCodeSection() {
        ...
        for (let i = 0; i < oldCodeCount; ++i) {
            ...
            const oldFuncData = new BufferReader2(oldFunc);
